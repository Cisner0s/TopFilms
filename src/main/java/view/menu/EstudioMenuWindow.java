...
import controller.menus.EstudioMenuController;
 ...
 * @author DCM
 */
public class EstudioMenuWindow extends javax.swing.JFrame {

    /**
     * Creates new form ShowWindow
     */
    public EstudioMenuWindow() {
        initComponents();
        setResizable(false);
        ...
        EstudioMenuController ctr = new EstudioMenuController(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstudioMenuWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
