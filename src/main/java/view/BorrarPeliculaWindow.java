...
import controller.BorrarPeliculaController;

/**
 *
 * @author DCM
 */
public class BorrarPeliculaWindow extends javax.swing.JFrame {

    /**
     * Creates new form BorrarPeliculaWindow
     */
    public BorrarPeliculaWindow() {
        initComponents();
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Borrar Pelicula");
        ...
        jLabel4.setText("Datos del Pelicula seleccionada");
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 250, 340, 150));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrarPeliculaWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
